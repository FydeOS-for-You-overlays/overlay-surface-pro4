 ...
 *
 * Disassembly of dsdt.dat, Wed Aug 26 13:57:00 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00017634 (95796)
 *     Revision         0x02
 *     Checksum         0x76
 *     OEM ID           "MSFT  "
 *     OEM Table ID     "MSFT    "
...
DefinitionBlock ("", "DSDT", 2, "MSFT  ", "MSFT    ", 0x00000000)
{
    ...
    Scope (_SB.PCI0.LPCB)
    {
        Device (EC0)
        {
            ...
            Method (_Q64, 0, NotSerialized)  // _Qxx: EC Query
            {
                ...
                If ((^RFSD.GRFM (^RFSD.RFSA, Zero, 0x0100) == One))
                {
                    Acquire (^RFSD.RFMT, 0xFFFF)
                    ^RFSD.RFIX = 0x0100
                    ^RFSD.RFTV = One
                ...
                Notify (RFSD, 0x80) // Status Change
            }
            ...
            Device (RFSD)
            {
                ...
                Method (GRFA, 0, Serialized)
                {
                    ...
                    RFSA = REXD /* \_SB_.PCI0.LPCB.EC0_.REXD */
                    Release (RFMT)
                    Return (One)
                }
                ...
                Method (GRFB, 1, Serialized)
                {
                    ...
                    RFTW = REXD /* \_SB_.PCI0.LPCB.EC0_.REXD */
                    RTHB = Zero
                    Release (RFMT)
                    Return (One)
                }
                ...
                Method (GRFM, 3, Serialized)
                {
                    ...
                    {
                        RFTW = REXD /* \_SB_.PCI0.LPCB.EC0_.REXD */
                        IBUF [(Arg1 + Local0)] = RTLB /* \_SB_.PCI0.LPCB.EC0_.RFSD.RTLB */
                        Local0++
                        IBUF [(Arg1 + Local0)] = RTHB /* \_SB_.PCI0.LPCB.EC0_.RFSD.RTHB */
                        Local0++
                    }
                ...
                Method (GRFT, 1, Serialized)
                {
                    ...
                    Local0 = (Arg0 - RFIX) /* \_SB_.PCI0.LPCB.EC0_.RFSD.RFIX */
                    If ((Local0 != Zero))
                    {
                ...
                Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
                {
                    If ((Arg0 == ToUUID ("bae38c2a-6c4e-4be1-9102-cbba77b39b02")))
                    {
                        If ((Arg2 == Zero))
                        {
                            Return (Buffer (0x02)
                        ...
                        If ((Arg2 == 0x02))
                        {
                            If ((GRFB (0x28) == One))
                            {
                                RFCI = RTLB /* \_SB_.PCI0.LPCB.EC0_.RFSD.RTLB */
                                Return (RFCI) /* \_SB_.PCI0.LPCB.EC0_.RFSD.RFCI */
                            }
                            Else
                            {
                                Return (Zero)
                        ...
                        If ((Arg2 == 0x03))
                        {
                            Return (RRCR) /* \_SB_.PCI0.LPCB.EC0_.RRCR */
                        }
                        ...
                        If ((Arg2 == 0x06))
                        {
                            Return (RWDC) /* \_SB_.PCI0.LPCB.EC0_.RWDC */
                        }
                        ...
                        If ((Arg2 == 0x08))
                        {
                            ...
                            While ((Local0 < 0x04))
                            {
                                ...
                                RFTQ [Local2] = RTLB /* \_SB_.PCI0.LPCB.EC0_.RFSD.RTLB */
                                Local2++
                                RFTQ [Local2] = RTHB /* \_SB_.PCI0.LPCB.EC0_.RFSD.RTHB */
                                Local2++
                                Local0++
                                Local1 -= 0x02
                                If ((Local2 > 0x07))
                            ...
                            Return (RFTQ) /* \_SB_.PCI0.LPCB.EC0_.RFSD.RFTQ */
                        }
                    }
    ...
    Scope (_SB)
    {
        ...
        Device (WSID)
        {
            ...
            {
                ADBG ("_SB.WSID._DSM")
                If ((Arg0 == ToUUID ("fa62fafd-c5d4-48ac-b31e-896aa4f68438")))
                {
                    If ((Zero == ToInteger (Arg1)))
                    {
                        Switch (ToInteger (Arg2))
        ...
        Device (SARB)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (SBUF) /* \_SB_.SARB._CRS.SBUF */
            }
            ...
            Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
            {
                If ((Arg0 == ToUUID ("cf25be87-4621-40ce-bf12-2ff9ff5d38c4")))
                {
                    If ((Zero == ToInteger (Arg1)))
                    {
                        Switch (ToInteger (Arg2))
    ...
    Scope (_GPE)
    {
        ...
        Method (_L05, 0, NotSerialized)  // _Lxx: Level-Triggered GPE
        {
            ...
            Notify (\_SB.PCI0.XHC.RHUB.SS04, One) // Device Check
        }
            ...
            Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
            {
                If ((Arg0 == ToUUID ("c4eb40a0-6cd2-11e2-bcfd-0800200c9a66")))
                {
                    ...
                    If ((Arg2 == One))
                    {
                        ...
                        If ((^^PCI0.RP09.VDID == 0xFFFFFFFF))
                        {
                            DerefOf (DEVY [0x21]) [One] = Zero
                        }
